...
export class GroqCodeFixerService extends AbstractCodeFixerService {
  constructor(
    ...
    super('groq', context, settingsManager, defaultModelName, availableModelNames);
  }
  ...
  public async getResponse(
    ...
    const generativeModel = new ChatGroq({
